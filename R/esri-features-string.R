...
as_esri_features_sfc <- function(x, crs = NULL, call = rlang::caller_env()) {
  ...
  if (three_dim) {
    switch(sfc_class,
      "sfc_POINT" = sfc_point_features_3d_string(x, sr),
      "sfc_MULTIPOINT" = sfc_multipoint_features_3d_string(x, sr),
      "sfc_LINESTRING" = sfc_linestring_features_3d_string(x, sr),
      "sfc_MULTILINESTRING" = sfc_multilinestring_features_3d_string(x, sr),
      "sfc_POLYGON" = sfc_polygon_features_3d_string(x, sr),
      "sfc_MULTIPOLYGON" = sfc_multipolygon_features_3d_string(x, sr),
    )
  } else {
    switch(sfc_class,
      "sfc_POINT" = sfc_point_features_2d_string(x, sr),
      "sfc_MULTIPOINT" = sfc_multipoint_features_2d_string(x, sr),
      "sfc_LINESTRING" = sfc_linestring_features_2d_string(x, sr),
      "sfc_MULTILINESTRING" = sfc_multilinestring_features_2d_string(x, sr),
      "sfc_POLYGON" = sfc_polygon_features_2d_string(x, sr),
      "sfc_MULTIPOLYGON" = sfc_multipolygon_features_2d_string(x, sr),
    )
  }
}
