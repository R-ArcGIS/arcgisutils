...
#' @rdname auth
#' @export
#' @param token an object of class `httr2_token` as generated by `auth_code()` or `auth_client()`.
#' @param quietly default `FALSE`. Whether function is verbose.
...
#' @rdname auth
#' @export
#' @param refresh_threshold default `0`. If token expiry is within this threshold (in seconds)
#' the token will be refreshed only if a `refresh_token` is available. Token refreshing is only
#' possible with `auth_code()` flow.
#'
