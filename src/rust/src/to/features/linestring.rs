...
#[extendr]
fn sfc_linestring_features_2d_string(x: List, sr: Robj) -> String {
...
#[extendr]
fn sfc_linestring_features_2d_list(x: List, sr: Robj) -> Robj {
    let sr = deserialize_sr(&sr);
    let res = SfcLineString(x).as_features_2d(sr).unwrap();
...
#[extendr]
fn sfc_linestring_features_3d_string(x: List, sr: Robj) -> String {
    let sr = deserialize_sr(&sr);
    let res = SfcLineString(x).as_features_3d(sr).unwrap();
    serde_json::to_string(&res).unwrap()
}
#[extendr]
fn sfc_linestring_features_3d_list(x: List, sr: Robj) -> Robj {
    let sr = deserialize_sr(&sr);
    let res = SfcLineString(x).as_features_3d(sr).unwrap();
    extendr_api::serializer::to_robj(&res).unwrap()
}
...
#[extendr]
fn sfc_linestring_featureset_2d_string(x: List, sr: Robj) -> String {
...
#[extendr]
fn sfc_linestring_featureset_2d_list(x: List, sr: Robj) -> Robj {
    let sfc = SfcLineString(x);
    let crs = deserialize_sr(&sr);
    let featureset = sfc.as_featureset_2d(crs);
...
#[extendr]
fn sfc_linestring_featureset_3d_string(x: List, sr: Robj) -> String {
    let sfc = SfcLineString(x);
    let crs = deserialize_sr(&sr);
...
#[extendr]
fn sfc_linestring_featureset_3d_list(x: List, sr: Robj) -> Robj {
    let sfc = SfcLineString(x);
    let crs = deserialize_sr(&sr);
    let featureset = sfc.as_featureset_3d(crs);
    extendr_api::serializer::to_robj(&featureset).unwrap()
...
extendr_module! {
    mod linestring;
    fn sfc_linestring_features_2d_list;
    fn sfc_linestring_features_2d_string;
    fn sfc_linestring_features_3d_list;
    fn sfc_linestring_features_3d_string;
    fn sfc_linestring_featureset_2d_list;
    fn sfc_linestring_featureset_2d_string;
    fn sfc_linestring_featureset_3d_list;
    fn sfc_linestring_featureset_3d_string;
}
