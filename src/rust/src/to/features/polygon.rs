...
#[extendr]
fn sfc_polygon_features_2d_string(x: List, sr: Robj) -> String {
...
#[extendr]
fn sfc_polygon_features_3d_string(x: List, sr: Robj) -> String {
    let sr = deserialize_sr(&sr);
...
#[extendr]
fn sfc_polygon_featureset_2d_string(x: List, sr: Robj) -> String {
...
#[extendr]
fn sfc_polygon_featureset_3d_string(x: List, sr: Robj) -> String {
    let sfc = SfcPolygon(x);
    let crs = deserialize_sr(&sr);
...
#[extendr]
fn sfc_polygon_features_2d_list(x: List, sr: Robj) -> Robj {
    let sr = deserialize_sr(&sr);
    let res = SfcPolygon(x).as_features_2d(sr).unwrap();
...
#[extendr]
fn sfc_polygon_features_3d_list(x: List, sr: Robj) -> Robj {
    let sr = deserialize_sr(&sr);
    let res = SfcPolygon(x).as_features_3d(sr).unwrap();
    extendr_api::serializer::to_robj(&res).unwrap()
}
...
#[extendr]
fn sfc_polygon_featureset_2d_list(x: List, sr: Robj) -> Robj {
    let sfc = SfcPolygon(x);
    let crs = deserialize_sr(&sr);
    let featureset = sfc.as_featureset_2d(crs);
...
#[extendr]
fn sfc_polygon_featureset_3d_list(x: List, sr: Robj) -> Robj {
    let sfc = SfcPolygon(x);
    let crs = deserialize_sr(&sr);
    let featureset = sfc.as_featureset_3d(crs);
    extendr_api::serializer::to_robj(&featureset).unwrap()
...
extendr_module! {
    mod polygon;
    fn sfc_polygon_features_2d_string;
    fn sfc_polygon_features_3d_string;
    fn sfc_polygon_featureset_2d_string;
    fn sfc_polygon_featureset_3d_string;
    fn sfc_polygon_features_2d_list;
    fn sfc_polygon_features_3d_list;
    fn sfc_polygon_featureset_2d_list;
    fn sfc_polygon_featureset_3d_list;
}
